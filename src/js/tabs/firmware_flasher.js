...
TABS.firmware_flasher = {
    releases: null,
    releaseChecker: new ReleaseChecker('firmware', 'https://api.github.com/repos/hoovflight/hoovflight/releases')
};
            ...
            if (!releaseData) {
                ...
                releaseData.forEach(function(release){
                    release.assets.forEach(function(asset){
                        var targetFromFilenameExpression = /hoovflight_([\d.]+)?_?(\w+)(\-.*)?\.(.*)/;
            ...
            function process_hex(data, summary) {
                ...
                parse_hex(intel_hex, function (data) {
                    ...
                    if (parsed_hex) {
                        ...
                        var formattedNotes = summary.notes.replace(/#(\d+)/g, '[#$1](https://github.com/hoovflight/hoovflight/pull/$1)');
